...
# Set the caption and change the icon
pygame.display.set_caption("S KILLER")
pygame.display.set_icon(pygame.image.load("Assets/icon/ninja.png"))

# Set the background music
pygame.mixer.music.load('Assets/Menu/kuno_boss.mp3')
...
def draw_background(path, player, offset_x, objects=None, window=None):
    ...
    # Draw life
    heart = pygame.image.load("Assets/items/heart.png")
    ...
    if window != None:
        ...
        font = pygame.font.Font('Assets/Font/OpenSans-Bold.ttf', 30)
...
def draw_menu(window):
    ...
    # Load images
    start = pygame.image.load("Assets/Menu/Start.png")
...
def main(window):
    ...
    while run:
        ...
        if game_active:
            ...
            draw_background("Assets/Background/Purple.png", player, offset_x, objects, window)
            ...
            draw_background("Assets/Background/Purple.png", player, offset_x)
